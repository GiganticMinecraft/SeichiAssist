...
object MenuInventoryData {
  ...
  def getSetBlockSkillData(p: Player): Inventory = {
    ...
    itemmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "元のページへ"
    itemmeta.lore = lore
    ...
    itemmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "設置時に下の空洞を埋める機能"
    ...
    itemmeta = Bukkit.getItemFactory().getItemMeta(Material.STONE)
    itemmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "現在の設定は以下の通りです"
    ...
    itemstack.durability = 3.toShort()
    skullmeta.displayName = RED.toString() + "" + UNDERLINE + "" + BOLD + "範囲設定を最大値に変更"
    ...
    itemstack.durability = 3.toShort()
    skullmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "範囲設定を一段階大きくする"
    ...
    skullmeta = ItemMetaFactory.SKULL.value
    itemstack.durability = 3.toShort()
    skullmeta.displayName = RED.toString() + "" + UNDERLINE + "" + BOLD + "範囲設定を初期値に変更"
    ...
    skullmeta = ItemMetaFactory.SKULL.value
    itemstack.durability = 3.toShort()
    skullmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "範囲設定を一段階小さくする"
    ...
    skullmeta = ItemMetaFactory.SKULL.value
    itemstack.durability = 3.toShort()
    skullmeta.displayName = RED.toString() + "" + UNDERLINE + "" + BOLD + "範囲設定を最小値に変更"
    ...
    itemmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "MineStack優先設定：" + ZSSkill_Minestack
    lore = List(RESET.toString() + "" + GRAY + "スキルでブロックを並べるとき", RESET.toString() + "" + GRAY + "MineStackの在庫を優先して消費します。", RESET.toString() + "" + GRAY + "建築LV" + BuildAssist.config.zoneskillMinestacklevel + "以上で利用可能", RESET.toString() + "" + GRAY + "クリックで切り替え"
    )
    itemmeta.lore = lore
    itemstack.itemMeta = itemmeta
  ...
  def getBlockLineUpData(p: Player): Inventory = {
    ...
    // ホームを開く
    itemstack.durability = 3.toShort()
    skullmeta.displayName = s"${YELLOW}${UNDERLINE}${BOLD}ホームへ"
    skullmeta.lore = lore
    ...
    itemmeta.displayName = s"${YELLOW}${UNDERLINE}${BOLD}ブロックを並べるスキル（仮） ：${BuildAssist.line_up_str[playerdata.line_up_flg]}"
    lore = List(
    ...
    itemmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "ハーフブロック設定 ：" + BuildAssist.line_up_step_str[playerdata.line_up_step_flg]
    lore = List(
    ...
    itemmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "破壊設定 ：" + BuildAssist.line_up_off_on_str[playerdata.line_up_des_flg]
    lore = List(
    ...
    itemstack = ItemStack(Material.CHEST, 1)
    itemmeta = Bukkit.getItemFactory().getItemMeta(Material.CHEST)
    itemmeta.displayName = s"${YELLOW}${UNDERLINE}${BOLD}MineStack優先設定 ：${BuildAssist.line_up_off_on_str[playerdata.line_up_minestack_flg]}"
    lore = List(
  ...
  def getBlockCraftData(p: Player): Inventory = {
    ...
    skullmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "ホームへ"
    lore = ImmutableListFactory.of(RESET.toString() + "" + DARK_RED + "" + UNDERLINE + "クリックで移動")
    skullmeta.lore = lore
    skullmeta.owner = "MHF_ArrowLeft"
    itemstack.itemMeta = skullmeta
    ...
    itemstack = ItemStack(Material.SKULL_ITEM, 1, 3.toShort())
    skullmeta = ItemMetaFactory.SKULL.value
    skullmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "2ページ目へ"
    ...
    for (x in 1..5) {
      ...
      itemmeta = Bukkit.getItemFactory().getItemMeta(Material.STEP)
      itemmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "石を石ハーフブロックに変換します"
      lore = List(
    ...
    for (x in 1..5) {
      ...
      itemmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "石を石レンガに変換します"
    ...
    for (x in 1..4) {
      ...
      itemmeta = Bukkit.getItemFactory().getItemMeta(Material.STONE)
      itemmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "花崗岩を磨かれた花崗岩に変換します"
    ...
    for (x in 1..4) {
      ...
      itemmeta = Bukkit.getItemFactory().getItemMeta(Material.STONE)
      itemmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "閃緑岩を磨かれた閃緑岩に変換します"
    ...
    for (x in 1..4) {
      ...
      itemmeta = Bukkit.getItemFactory().getItemMeta(Material.STONE)
      itemmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "安山岩を磨かれた安山岩に変換します"
    ...
    for (x in 1..4) {
      ...
      itemmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "ネザー水晶をネザー水晶ブロックに変換します"
    ...
    for (x in 1..4) {
      ...
      itemmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "レンガをレンガブロックに変換します"
    ...
    for (x in 1..4) {
      ...
      itemmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "ネザーレンガをネザーレンガブロックに変換します"
      lore = List(
  ...
  def getBlockCraftData2(p: Player): Inventory = {
    ...
    skullmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "1ページ目へ"
    lore = ImmutableListFactory.of(RESET.toString() + "" + DARK_RED + "" + UNDERLINE + "クリックで移動")
    skullmeta.lore = lore
    skullmeta.owner = "MHF_ArrowUp"
    itemstack.itemMeta = skullmeta
    ...
    itemstack = ItemStack(Material.SKULL_ITEM, 1, 3)
    skullmeta = ItemMetaFactory.SKULL.value
    skullmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "3ページ目へ"
    lore = ImmutableListFactory.of(RESET.toString() + "" + DARK_RED + "" + UNDERLINE + "クリックで移動")
    skullmeta.lore = lore
    skullmeta.owner = "MHF_ArrowDown"
    itemstack.itemMeta = skullmeta
    ...
    for (x in 1..4) {
      ...
      itemmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "雪玉を雪（ブロック）に変換します"
      lore = ImmutableListFactory.of(RESET.toString() + "" + GRAY + "雪玉" + p10 * 4 + "個→雪（ブロック）" + p10 + "個", RESET.toString() + "" + GRAY + "雪玉の数:" + comma(num_1), RESET.toString() + "" + GRAY + "雪（ブロック）の数:" + comma(num_2), RESET.toString() + "" + GRAY + "建築LV" + BuildAssist.config.getMinestackBlockCraftlevel(2) + "以上で利用可能", RESET.toString() + "" + DARK_RED + "" + UNDERLINE + "クリックで変換"
      )
      itemmeta.lore = lore
      itemstack.itemMeta = itemmeta
      inventory.setItem(x - 1, itemstack)
    ...
    for (x in 1..5) {
      ...
      itemmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "ネザーウォートとネザーレンガを赤いネザーレンガに変換します"
    ...
    for (x in 0..3) {
      ...
      itemstack = ItemStack(Material.GOLD_INGOT, x)
      itemmeta = Bukkit.getItemFactory().getItemMeta(Material.GOLD_INGOT)
      itemmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "溶岩バケツを消費して金鉱石を金インゴットに変換します"
    ...
    for (x in 0..3) {
      ...
      itemmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "石炭を消費して砂をガラスに変換します"
      lore = ImmutableListFactory.of(RESET.toString() + "" + GRAY + "砂" + p10 * 4 + "個+石炭" + p10 + "個→ガラス" + p10 * 4 + "個", RESET.toString() + "" + GRAY + "砂の数:" + comma(num_1), RESET.toString() + "" + GRAY + "石炭の数:" + comma(num_3), RESET.toString() + "" + GRAY + "ガラスの数:" + comma(num_2), RESET.toString() + "" + GRAY + "建築LV" + BuildAssist.config.getMinestackBlockCraftlevel(3) + "以上で利用可能", RESET.toString() + "" + DARK_RED + "" + UNDERLINE + "クリックで変換"
      )
      itemmeta.lore = lore
      itemstack.itemMeta = itemmeta
  ...
  def getBlockCraftData3(p: Player): Inventory = {
    ...
    run {
      ...
      for (x in 0..3) {
        ...
        itemmeta.displayName = YELLOW.toString() + "" + UNDERLINE + "" + BOLD + "石炭を消費して粘土をレンガに変換します"
