...
class PlayerData(
  ...
  @JvmOverloads
  def updateNickname(id1: Int = settings.nickName.id1, id2: Int = settings.nickName.id2, id3: Int = settings.nickName.id3, style: PlayerNickName.Style = settings.nickName.style) {
