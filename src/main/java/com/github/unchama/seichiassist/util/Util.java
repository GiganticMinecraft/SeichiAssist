...
public final class Util {
    ...
    /**
     * 与えられた {@link Player} の存在するワールドが,スキルを発動可能かを返します.
     * ただし、debugモードの場合は常に {@code true} を返します.
     *
     * @param player 確認したい {@link Player}
     * @return {@code true} : 発動可能 / {@code false} 発動不可 (debugモードの場合 {@code true})
     */
    ...
    /**
     * 与えられた {@link Player} が整地ワールドにいるか返します.
     * ただし、debugモードの場合は常に {@code true} を返します.
     *
     * @param player 確認したい {@link Player}
     * @return {@code true} : 整地ワールドにいる / {@code false} 整地ワールド以外にいる (debugモードの場合 {@code true})
     */
    public static boolean isSeichiWorld(Player player) {
        ...
        return Worlds.seichiWorldNames.contains(worldName);
    }
    ...
    // TODO これはここにあるべきではない
    @Deprecated
    public static @Nullable MineStackObj findMineStackObjectByName(String name) {
