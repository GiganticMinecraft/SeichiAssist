...
object MineStackObjectList {
  ...
  val minestacklistbuild = listOf(
      ...
      MineStackBuildObj("stained_clay9", "青緑色のテラコッタ", 1, Material.STAINED_CLAY, 9),
      ...
      MineStackBuildObj("concrete9", "青緑色のコンクリート", 1, Material.CONCRETE, 9),
      ...
      MineStackBuildObj("concrete_powder9", "青緑色のコンクリートパウダー", 1, Material.CONCRETE_POWDER, 9),
      ...
      MineStackBuildObj("wool_9", "青緑色の羊毛", 1, Material.WOOL, 9),
      ...
      MineStackBuildObj("carpet_9", "青緑色のカーペット", 1, Material.CARPET, 9),
      ...
      MineStackBuildObj("stained_glass_9", "青緑色の色付きガラス", 1, Material.STAINED_GLASS, 9),
      ...
      MineStackBuildObj("glass_panel_9", "青緑色の色付きガラス板", 1, Material.STAINED_GLASS_PANE, 9),
      ...
      MineStackBuildObj("dye_6", "青緑色の染料", 1, Material.INK_SACK, 6),
