...
UPDATE mine_stack
    SET object_name = CONCAT('tmp_gachadata0_', CONVERT(REPLACE(object_name, 'gachadata0_', ''), INT) + 2)
    WHERE object_name
      NOT LIKE 'gachadata0_exp_bottle' AND object_name LIKE 'gachadata0_%';

UPDATE mine_stack
    SET object_name = REPLACE(object_name, 'tmp_', '')
