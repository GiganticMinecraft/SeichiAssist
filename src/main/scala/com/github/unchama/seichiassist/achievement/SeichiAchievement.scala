...
object SeichiAchievement extends Enum[SeichiAchievement] {
  ...
  case object No_5009 extends HiddenAuto(5009, dependsOn(5001, consecutiveLoginDays_>=(200)))
  case object No_5010 extends HiddenAuto(5010, dependsOn(5009, consecutiveLoginDays_>=(300)))
  case object No_5011 extends HiddenAuto(5011, dependsOn(5010, consecutiveLoginDays_>=(365)))
  case object No_5012 extends HiddenAuto(5012, dependsOn(5011, consecutiveLoginDays_>=(540)))
  case object No_5013 extends HiddenAuto(5013, dependsOn(5012, consecutiveLoginDays_>=(730)))
  case object No_5014 extends HiddenAuto(5014, dependsOn(5013, consecutiveLoginDays_>=(910)))
  case object No_5015 extends HiddenAuto(5015, dependsOn(5014, consecutiveLoginDays_>=(1095)))
  case object No_5016 extends HiddenAuto(5016, dependsOn(5015, consecutiveLoginDays_>=(1460)))
