...
object Nicknames {
  val map: Map[Int, NicknamesToBeUnlocked] = Map(
    // 整地ランキング実績
    ...
    2012 -> HeadTail(s"底なし", s"精神"),
    2013 -> HeadTail(s"狂気", s"心得"),
    2014 -> HeadTail(s"プロ", s"建築士"),
