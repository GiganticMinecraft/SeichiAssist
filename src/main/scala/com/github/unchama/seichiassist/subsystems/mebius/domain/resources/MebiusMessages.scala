...
object MebiusMessages {
  ...
  val tips: List[String] = List(
    ...
    "綺麗に掘るのが整地の醍醐味だよねー！",
    // TODO: 整地鯖6周年のMebius追加メッセージ。7/6頃まで表示されるべき。
    // https://github.com/GiganticMinecraft/SeichiAssist/pull/1517
    "おめでとう！整地鯖6周年のご挨拶、だよ！",
    "整地鯖は6歳になったんだって！誕生日ケーキもらえないかなあ。",
    "ねぇねぇ！6/29は特別で大切な日なんだよ！",
    "こんぐらっちゅれーしょんず、せいちさーばー6thあにばーさりー！",
    "6/29は6周年のお祝い！お祝いと言ったらごちそうだね！何食べよっか？"
  )
