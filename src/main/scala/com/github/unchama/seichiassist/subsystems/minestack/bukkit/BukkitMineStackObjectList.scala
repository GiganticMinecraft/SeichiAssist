...
class BukkitMineStackObjectList[F[_]: Sync](
  ...
  private val minestacklistmine: List[MineStackObjectGroup[ItemStack]] = leftElems(
    ...
    MineStackObjectByMaterial(ORES, "coal_1", "木炭", Material.COAL),
    ...
    MineStackObjectByMaterial(ORES, "charcoal", "木炭", Material.CHARCOAL),
  ...
  private val minestacklistdrop: List[MineStackObjectGroup[ItemStack]] = leftElems(
    ...
    MineStackObjectByMaterial(MOB_DROP, "player_head", "プレイヤーの頭", Material.PLAYER_HEAD),
  ...
  private val minestacklistfarm: List[MineStackObjectGroup[ItemStack]] = leftElems(
    ...
    MineStackObjectByMaterial(AGRICULTURAL, "long_grass1", "草", Material.GRASS),
    ...
    MineStackObjectByMaterial(AGRICULTURAL, "melon", "スイカ", Material.MELON),
    MineStackObjectByMaterial(AGRICULTURAL, "melon_block", "スイカ", Material.MELON),
    MineStackObjectByMaterial(AGRICULTURAL, "brown_mushroom", "キノコ", Material.BROWN_MUSHROOM),
    MineStackObjectByMaterial(AGRICULTURAL, "red_mushroom", "キノコ", Material.RED_MUSHROOM),
    ...
    MineStackObjectByMaterial(AGRICULTURAL, "candle_cake", "ろうそくが立てられたケーキ", Material.CANDLE_CAKE),
    MineStackObjectByMaterial(AGRICULTURAL, "white_candle_cake", "白色のろうそく付きケーキ", Material.WHITE_CANDLE_CAKE),
    MineStackObjectByMaterial(AGRICULTURAL, "orange_candle_cake", "橙色のろうそく付きケーキ", Material.ORANGE_CANDLE_CAKE),
    MineStackObjectByMaterial(AGRICULTURAL, "magenta_candle_cake", "赤紫色のろうそく付きケーキ", Material.MAGENTA_CANDLE_CAKE),
    MineStackObjectByMaterial(AGRICULTURAL, "light_blue_candle_cake", "空色のろうそく付きケーキ", Material.LIGHT_BLUE_CANDLE_CAKE),
    MineStackObjectByMaterial(AGRICULTURAL, "yellow_candle_cake", "黄色のろうそく付きケーキ", Material.YELLOW_CANDLE_CAKE),
    MineStackObjectByMaterial(AGRICULTURAL, "lime_candle_cake", "黄緑色のろうそく付きケーキ", Material.LIME_CANDLE_CAKE),
    MineStackObjectByMaterial(AGRICULTURAL, "pink_candle_cake", "桃色のろうそく付きケーキ", Material.PINK_CANDLE_CAKE),
    MineStackObjectByMaterial(AGRICULTURAL, "gray_candle_cake", "灰色のろうそく付きケーキ", Material.GRAY_CANDLE_CAKE),
    MineStackObjectByMaterial(AGRICULTURAL, "light_gray_candle_cake", "薄灰色のろうそく付きケーキ", Material.LIGHT_GRAY_CANDLE_CAKE),
    MineStackObjectByMaterial(AGRICULTURAL, "cyan_candle_cake", "青緑色のろうそく付きケーキ", Material.CYAN_CANDLE_CAKE),
    MineStackObjectByMaterial(AGRICULTURAL, "purple_candle_cake", "紫色のろうそく付きケーキ", Material.PURPLE_CANDLE_CAKE),
    MineStackObjectByMaterial(AGRICULTURAL, "blue_candle_cake", "青色のろうそく付きケーキ", Material.BLUE_CANDLE_CAKE),
    MineStackObjectByMaterial(AGRICULTURAL, "brown_candle_cake", "茶色のろうそく付きケーキ", Material.BROWN_CANDLE_CAKE),
    MineStackObjectByMaterial(AGRICULTURAL, "green_candle_cake", "緑色のろうそく付きケーキ", Material.GREEN_CANDLE_CAKE),
    MineStackObjectByMaterial(AGRICULTURAL, "red_candle_cake", "赤色のろうそく付きケーキ", Material.RED_CANDLE_CAKE),
    MineStackObjectByMaterial(AGRICULTURAL, "black_candle_cake", "黒色のろうそく付きケーキ", Material.BLACK_CANDLE_CAKE),
    ...
    MineStackObjectByMaterial(AGRICULTURAL, "melon_slice", "スイカの薄切り", Material.MELON_SLICE),
  ...
  private val minestacklistbuild: List[MineStackObjectGroup[ItemStack]] = leftElems(
    ...
    MineStackObjectByMaterial(BUILDING, "sandstone1", "模様入りの砂岩", Material.SANDSTONE),
    MineStackObjectByMaterial(BUILDING, "sandstone2", "なめらかな砂岩", Material.SANDSTONE),
    MineStackObjectByMaterial(BUILDING, "red_sand", "赤い砂", Material.SAND),
    ...
    MineStackObjectByMaterial(BUILDING, "red_sandstone1", "模様入りの赤い砂岩", Material.RED_SANDSTONE),
    MineStackObjectByMaterial(BUILDING, "red_sandstone2", "なめらかな赤い砂岩", Material.RED_SANDSTONE),
    ...
    MineStackObjectByMaterial(BUILDING, "quartz_block1", "模様入りネザー水晶ブロック", Material.QUARTZ_BLOCK),
    MineStackObjectByMaterial(BUILDING, "quartz_block2", "柱状ネザー水晶ブロック", Material.QUARTZ_BLOCK),
    ...
    MineStackObjectByMaterial(BUILDING, "wet_sponge", "濡れたスポンジ", Material.SPONGE),
    ...
    MineStackObjectByMaterial(BUILDING, "sign", "看板", Material.OAK_SIGN), // 1.16からSIGNが素材ごとに別れたので、オークに決めうちしておく
    ...
    MineStackObjectByMaterial(BUILDING, "chiseled_sandstone", "模様入りの砂岩", Material.CHISELED_SANDSTONE),
    ...
    MineStackObjectByMaterial(BUILDING, "smooth_red_sandstone", "滑らかな赤い砂岩", Material.SMOOTH_RED_SANDSTONE),
    MineStackObjectByMaterial(BUILDING, "smooth_sandstone", "滑らかな砂岩", Material.SMOOTH_SANDSTONE),
    ...
    MineStackObjectByMaterial(BUILDING, "chiseled_quartz_block", "模様入りのクォーツブロック", Material.CHISELED_QUARTZ_BLOCK),
    MineStackObjectByMaterial(BUILDING, "quartz_bricks", "クォーツレンガ", Material.QUARTZ_BRICKS),
    MineStackObjectByMaterial(BUILDING, "quartz_pillar", "クォーツの柱", Material.QUARTZ_PILLAR),
    ...
    MineStackObjectByMaterial(BUILDING, "chiseled_red_sandstone", "模様入りの赤い砂岩", Material.CHISELED_RED_SANDSTONE),
    ...
    MineStackObjectByMaterial(BUILDING, "tall_seagrass", "背の高い海草", Material.TALL_SEAGRASS),
    MineStackObjectByMaterial(BUILDING, "wall_torch", "壁に付けられた松明", Material.WALL_TORCH),
    MineStackObjectByMaterial(BUILDING, "fire", "炎", Material.FIRE),
    MineStackObjectByMaterial(BUILDING, "soul_fire", "魂の炎", Material.SOUL_FIRE),
    MineStackObjectByMaterial(BUILDING, "bamboo_sapling", "タケノコ", Material.BAMBOO_SAPLING),
    MineStackObjectByMaterial(BUILDING, "bubble_column", "気泡柱", Material.BUBBLE_COLUMN),
    MineStackObjectByMaterial(BUILDING, "sweet_berry_bush", "スイートベリーの低木", Material.SWEET_BERRY_BUSH),
    MineStackObjectByMaterial(BUILDING, "weeping_vines_plant", "しだれツタのつる", Material.WEEPING_VINES_PLANT),
    MineStackObjectByMaterial(BUILDING, "twisting_vines_plant", "ねじれツタのつる", Material.TWISTING_VINES_PLANT),
    MineStackObjectByMaterial(BUILDING, "crimson_wall_sign", "壁に付けられた真紅の看板", Material.CRIMSON_WALL_SIGN),
    MineStackObjectByMaterial(BUILDING, "warped_wall_sign", "壁に付けられた歪んだ看板", Material.WARPED_WALL_SIGN),
    MineStackObjectByMaterial(BUILDING, "potted_crimson_fungus", "植えられた真紅のキノコ", Material.POTTED_CRIMSON_FUNGUS),
    MineStackObjectByMaterial(BUILDING, "potted_warped_fungus", "植えられた歪んだキノコ", Material.POTTED_WARPED_FUNGUS),
    MineStackObjectByMaterial(BUILDING, "potted_crimson_roots", "植えられた真紅の根", Material.POTTED_CRIMSON_ROOTS),
    MineStackObjectByMaterial(BUILDING, "potted_warped_roots", "植えられた歪んだ根", Material.POTTED_WARPED_ROOTS),
    MineStackObjectByMaterial(BUILDING, "powder_snow", "粉雪", Material.POWDER_SNOW),
    MineStackObjectByMaterial(BUILDING, "cave_vines", "洞窟のツタ", Material.CAVE_VINES),
    MineStackObjectByMaterial(BUILDING, "cave_vines_plant", "洞窟のツタのつる", Material.CAVE_VINES_PLANT),
    MineStackObjectByMaterial(BUILDING, "big_dripleaf_stem", "大きなドリップリーフの茎", Material.BIG_DRIPLEAF_STEM),
    MineStackObjectByMaterial(BUILDING, "potted_azalea_bush", "植えられたツツジ", Material.POTTED_AZALEA_BUSH),
    MineStackObjectByMaterial(BUILDING, "potted_flowering_azalea_bush", "植えられた開花したツツジ", Material.POTTED_FLOWERING_AZALEA_BUSH),
    MineStackObjectByMaterial(BUILDING, "warped_fungus_on_a_stick", "歪んだキノコ付きの棒", Material.WARPED_FUNGUS_ON_A_STICK),
    MineStackObjectByMaterial(BUILDING, "structure_block", "ストラクチャーブロック", Material.STRUCTURE_BLOCK),
    ...
    MineStackObjectByMaterial(BUILDING, "water_cauldron", "水入りの大釜", Material.WATER_CAULDRON),
    MineStackObjectByMaterial(BUILDING, "lava_cauldron", "溶岩入りの大釜", Material.LAVA_CAULDRON),
    MineStackObjectByMaterial(BUILDING, "powder_snow_cauldron", "粉雪入りの大釜", Material.POWDER_SNOW_CAULDRON),
    MineStackObjectByMaterial(BUILDING, "tripwire", "トリップワイヤー", Material.TRIPWIRE),
    MineStackObjectByMaterial(BUILDING, "frosted_ice", "薄氷", Material.FROSTED_ICE),
  ) ++ rightElems(
  ...
  private val minestacklistrs: List[MineStackObjectGroup[ItemStack]] = leftElems(
    ...
    MineStackObjectByMaterial(REDSTONE_AND_TRANSPORTATION,"record_13","レコード",Material.MUSIC_DISC_13),
    MineStackObjectByMaterial(REDSTONE_AND_TRANSPORTATION,"record_cat","レコード",Material.MUSIC_DISC_CAT),
    MineStackObjectByMaterial(REDSTONE_AND_TRANSPORTATION,"record_blocks","レコード",Material.MUSIC_DISC_BLOCKS),
    MineStackObjectByMaterial(REDSTONE_AND_TRANSPORTATION,"record_chirp","レコード",Material.MUSIC_DISC_CHIRP),
    MineStackObjectByMaterial(REDSTONE_AND_TRANSPORTATION,"record_far","レコード",Material.MUSIC_DISC_FAR),
    MineStackObjectByMaterial(REDSTONE_AND_TRANSPORTATION,"record_mall","レコード",Material.MUSIC_DISC_MALL),
    MineStackObjectByMaterial(REDSTONE_AND_TRANSPORTATION,"record_mellohi","レコード",Material.MUSIC_DISC_MELLOHI),
    MineStackObjectByMaterial(REDSTONE_AND_TRANSPORTATION,"record_stal","レコード",Material.MUSIC_DISC_STAL),
    MineStackObjectByMaterial(REDSTONE_AND_TRANSPORTATION,"record_strad","レコード",Material.MUSIC_DISC_STRAD),
    MineStackObjectByMaterial(REDSTONE_AND_TRANSPORTATION,"record_ward","レコード",Material.MUSIC_DISC_WARD),
    MineStackObjectByMaterial(REDSTONE_AND_TRANSPORTATION,"record_11","レコード",Material.MUSIC_DISC_11),
    MineStackObjectByMaterial(REDSTONE_AND_TRANSPORTATION,"record_wait","レコード",Material.MUSIC_DISC_WAIT),
