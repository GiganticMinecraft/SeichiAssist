...
class BukkitMineStackObjectList[F[_]: Sync](
  ...
  private val minestacklistbuild: List[MineStackObjectGroup[ItemStack]] = leftElems(
    ...
    MineStackObjectByMaterial(BUILDING, "cobblestone_wall_0", "丸石の堀", Material.COBBLESTONE_WALL),
    MineStackObjectByMaterial(BUILDING, "mossy_cobblestone", "苔むした丸石", Material.MOSSY_COBBLESTONE),
    MineStackObjectByMaterial(BUILDING, "cobblestone_wall_1", "苔石の堀", Material.MOSSY_COBBLESTONE_WALL),
    ...
    MineStackObjectWithKindVariants(
      ...
      List(
        MineStackObjectByMaterial(BUILDING, "spruce_stairs", "マツの階段", Material.SPRUCE_STAIRS),
