...
object SeichiSkill extends Enum[SeichiSkill] {
  ...
  object MirageFlare extends ActiveSkill("mirage_flare", "ミラージュ・フレア", singleArea(5, 5, 3), Some(14), 30, 40)
  object Dockarn extends ActiveSkill("dockarn", "ドッ・カーン", singleArea(7, 7, 5), Some(30), 70, 50)
  object GiganticBomb extends ActiveSkill("gigantic_bomb", "ギガンティック・ボム", singleArea(9, 9, 7), Some(50), 100, 60)
  object BrilliantDetonation extends ActiveSkill("brilliant_detonation", "ブリリアント・デトネーション", singleArea(11, 11, 9), Some(70), 200, 70)
  object LemuriaImpact extends ActiveSkill("lemuria_impact", "レムリア・インパクト", singleArea(13, 13, 11), Some(100), 350, 80)
  object EternalVice extends ActiveSkill("eternal_vice", "エターナル・ヴァイス", singleArea(15, 15, 13), Some(140), 500, 90)
  ...
  object HolyShot extends ActiveSkill("holy_shot", "ホーリー・ショット", RemoteArea(5, 5, 3), Some(26), 35, 50)
  object TsarBomba extends ActiveSkill("tsar_bomba", "ツァーリ・ボンバ", RemoteArea(7, 7, 5), Some(32), 80, 60)
  object ArcBlast extends ActiveSkill("arc_blast", "アーク・ブラスト", RemoteArea(9, 9, 7), Some(54), 110, 70)
  object PhantasmRay extends ActiveSkill("phantasm_ray", "ファンタズム・レイ", RemoteArea(11, 11, 9), Some(76), 220, 80)
  object Supernova extends ActiveSkill("supernova", "スーパー・ノヴァ", RemoteArea(13, 13, 11), Some(110), 380, 90)
