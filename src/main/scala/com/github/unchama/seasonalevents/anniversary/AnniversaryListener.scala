...
object AnniversaryListener extends Listener {
  ...
  def onPlayerDeath(event: PlayerDeathEvent): Unit = {
    ...
    if (isPlayerInventoryFull(player)) {
      ...
      val command = s"""give ${player.getName} skull 1 3 {display:{Name:"まいんちゃん",Lore:["", ${YELLOW}ギガンティック☆整地鯖${ANNIVERSARY_COUNT}周年記念だよ！"]},SkullOwner:{Id:"fac7c46e-3e89-4249-bef6-948d5eb528c9",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNDhmNTQ0OGI0ZDg4ZTQwYjE0YzgyOGM2ZjFiNTliMzg1NDVkZGE5MzNlNzNkZmYzZjY5NWU2ZmI0Mjc4MSJ9fX0="}]}}}"""
