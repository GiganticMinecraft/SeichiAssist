  ...
  private object Reflection {
    ...
    object FileIOThread {
      private[Reflection] lazy val clazz: Class[_] =
        Class.forName(s"$nmsPackage_1_16_R1.FileIOThread")
    ...
    object Entity {
      private[Reflection] lazy val clazz: Class[_] =
        Class.forName(s"$nmsPackage_1_16_R1.Entity")
    ...
    object Chunk {
      private[Reflection] lazy val clazz: Class[_] = Class.forName(s"$nmsPackage_1_16_R1.Chunk")
    ...
    object World {
      private[Reflection] lazy val clazz: Class[_] = Class.forName(s"$nmsPackage_1_16_R1.World")
    ...
    object CraftWorld {
      private[Reflection] lazy val clazz: Class[_] =
        Class.forName(s"$craftBukkitPackage_1_16_R1.CraftWorld")
