package com.github.unchama.util.nms.v1_13_2.world
...
object WorldChunkSaving {
  ...
  private object Reflection {
    private val nmsPackage_1_13_R1 = "net.minecraft.server.v1_13_R1"
    private val craftBukkitPackage_1_13_R1 = "org.bukkit.craftbukkit.v1_13_R1"

    object FileIOThread {
      private[Reflection] lazy val clazz: Class[_] =
        Class.forName(s"$nmsPackage_1_13_R1.FileIOThread")
    ...
    object Entity {
      private[Reflection] lazy val clazz: Class[_] =
        Class.forName(s"$nmsPackage_1_13_R1.Entity")
    ...
    object Chunk {
      private[Reflection] lazy val clazz: Class[_] = Class.forName(s"$nmsPackage_1_13_R1.Chunk")
    ...
    object World {
      private[Reflection] lazy val clazz: Class[_] = Class.forName(s"$nmsPackage_1_13_R1.World")
    ...
    object CraftWorld {
      private[Reflection] lazy val clazz: Class[_] =
        Class.forName(s"$craftBukkitPackage_1_13_R1.CraftWorld")
